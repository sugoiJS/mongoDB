...
function disconnect(client, mongod, connection) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            //corrupt disconnect
            const connection = dummy_1.Dummy.getConnection();
...
function setResources() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < exports.recAmount; i++) {
            const dummy = dummy_1.Dummy.builder(`${exports.recNamePrefix}${i}`);
...
describe("Model read test suit", () => {
    ...
    it("Find by Id $in", () => __awaiter(this, void 0, void 0, function* () {
        ...
        const dummy = yield dummy_1.Dummy.find({ _id: { $in: [mongo_model_abstract_1.MongoModel.getIdObject(exports.mockObject.id)] } }, index_1.QueryOptions
            .builder()
            .setLimit(1)
            .setSortOptions(new index_1.SortItem(index_1.SortOptions.DESC, "lastSavedTime"))).then(res => res[0]);
        expect(dummy).toEqual(exports.mockObject);
    }));
});
//Update test suit
describe("Model update test suit", () => {
    ...
    it("update by id - validation pass", () => __awaiter(this, void 0, void 0, function* () {
        ...
        const dummy = yield dummy_1.Dummy.updateById(MockId, { name: "12", isUpdate: true })
            ...
            .then(res => res.ok ? dummy_1.Dummy.findOne({ _id: MockId }, index_1.QueryOptions.builder().setLimit(1)) : null)
            .then(res => {
            console.log(res);
            if (!res)
                res = {};
    ...
    it("update all", () => __awaiter(this, void 0, void 0, function* () {
        ...
        expect.assertions(2);
        const options = index_1.QueryOptions.builder().setSkipRequiredValidation(true);
        const query = { name: { $regex: exports.recNamePrefix } };
        let updateRes = yield dummy_1.Dummy.updateAll(query, { date }, options);
        let res = yield dummy_1.Dummy.find(query);
...
describe("Model remove test suit", () => {
    ...
    it("remove one - name", () => __awaiter(this, void 0, void 0, function* () {
        expect.assertions(1);
        const dummy = yield dummy_1.Dummy.removeOne({ name: { $regex: exports.recNamePrefix } }, index_1.QueryOptions.builder().setSortOptions(new index_1.SortItem(index_1.SortOptions.ASC, "lastSavedTime")))
            .then(res => res.n);
        expect(dummy).toBe(1);
    }));
    it("remove after find ", () => __awaiter(this, void 0, void 0, function* () {
        expect.assertions(1);
        const dummyRes = yield dummy_1.Dummy.findOne({ name: { $regex: exports.recNamePrefix } }, index_1.QueryOptions.builder().setSortOptions(new index_1.SortItem(index_1.SortOptions.DESC, "lastSavedTime")))
...
describe("Model extra functions", () => {
    ...
    it("Clone with Id", () => __awaiter(this, void 0, void 0, function* () {
        ...
        const dummy = dummy_1.Dummy.cast({ name, id: d.id });
    ...
    it("Failed because of required fields", () => __awaiter(this, void 0, void 0, function* () {
        expect.assertions(1);
        let dummy = dummy_1.Dummy.builder("tester_100");
        dummy.name = "";
        try {
