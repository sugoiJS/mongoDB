...
export { IBeforeValidate, IValidate, IAfterSave, IAfterUpdate, IBeforeSave, IBeforeUpdate, Primary, ConnectionName, ModelName, getPrimaryKey, QueryOptions, SortItem, SortOptions } from "@sugoi/orm";
