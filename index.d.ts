...
export { IBeforeValidate, IValidate, IAfterSave, IAfterUpdate, IBeforeSave, IBeforeUpdate, IBeforeRemove, IAfterRemove, IBeforeFind, IAfterFind, Primary, ConnectionName, ModelName, getPrimaryKey, QueryOptions, SortItem, SortOptions, SugoiModelException, Ignore, Required } from "@sugoi/orm";
